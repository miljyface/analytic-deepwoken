...
def _setup(args, message, clopen_manager):
    ...
    if len(args) < 2:
        return (discord.Embed(
            description="Usage: `.clopen setup <available_cat_id> <used_cat_id>`",
            color=0xED4245
        ), None)
    ...
    async def setup_async():
        ...
        embed = ClopenEmbedBuilder.setup_success(available_cat, used_cat)
...
def _set_userlimit(args, message, clopen_manager):
    if len(args) == 0:
        return (discord.Embed(
            description="Usage: `.clopen userlimit <number>`",
            color=0xED4245
        ), None)
...
def _set_min_available(args, message, clopen_manager):
    if len(args) == 0:
        return (discord.Embed(
            description="Usage: `.clopen minavailable <number>`",
            color=0xED4245
        ), None)
...
def _set_max_available(args, message, clopen_manager):
    if len(args) == 0:
        return (discord.Embed(
            description="Usage: `.clopen maxavailable <number>`",
            color=0xED4245
        ), None)
